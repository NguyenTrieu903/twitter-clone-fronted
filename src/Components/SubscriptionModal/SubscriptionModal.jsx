...
const featues=["Prioritized rankings in conversations and search",
        ...
        <Box sx={style}>
          ...
          <div className="flex justify-center py-10">
            <div className="w-[80%] space-y-10">
              ...
              <div className="flex justify-between border rounded-full px-5 py-3 border border-gray-500">
                <div>
                  <span
                    ...
                    className={`${
                      plan === "Anunally" ? "text-black" : "text-gray-400"
                    } cursor-pointer`}
                  >
                    Anunally
                  </span>
              ...
              {featues.map((item)=> <div className="flex items-center space-x-5">
